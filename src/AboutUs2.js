  ...
  const slides = [
    {
      id: 1,
      content: 'Content 1',
      description: 'TEDxIITGuwahati is an annual independently organised TEDx event that first started in 2016. Run entirely by a team of passionate volunteers, including undergraduate and post-graduate IIT Guwahati students, TEDxIITGuwahati brings a TED-like experience to the IIT Guwahati and wider Indian communities. TEDxIITGuwahati is an immersive event created to stimulate dialogue through engaging talks and session breaks designed to give individuals and organizations in India a platform to meet, share ideas and collaborate.',
